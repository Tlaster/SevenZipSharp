...
|-----------|----------|-----------|-------|
| master | [![Build status](https://ci.appveyor.com/api/projects/status/bgp7yh7f0fpamt95/branch/master?svg=true)](https://ci.appveyor.com/project/Tlaster/sevenzipsharp/branch/master) | [![Coverage Status](https://coveralls.io/repos/github/Tlaster/SevenZipSharp/badge.svg?branch=master)](https://coveralls.io/github/Tlaster/SevenZipSharp?branch=master) | [![NuGet Badge](https://buildstats.info/nuget/Tlaster.SevenZipSharp)](https://www.nuget.org/packages/Tlaster.SevenZipSharp/) |
| dev | [![Build status](https://ci.appveyor.com/api/projects/status/bgp7yh7f0fpamt95/branch/dev?svg=true)](https://ci.appveyor.com/project/Tlaster/sevenzipsharp/branch/dev) | [![Coverage Status](https://coveralls.io/repos/github/Tlaster/SevenZipSharp/badge.svg?branch=dev)](https://coveralls.io/github/Tlaster/SevenZipSharp?branch=dev) | 
